...
vi.mock("../lib/loupePreload", () => ({ preloadAssetLoupeBase: preload }));
vi.mock("../lib/previewQueue", () => ({ browserImageWorkerCount: 4 }));
vi.mock("../lib/browserImageCache", () => ({ protectBrowserImages: vi.fn() }));
