...
import { acceptImageProjection, clearImageProjections, invalidateImageProjection } from "@/lib/projection/imageProjection";
...
vi.mock("@/lib/cache/folderThumbnailCache", async (importOriginal) => ({
  ...await importOriginal<typeof import("@/lib/cache/folderThumbnailCache")>(),
