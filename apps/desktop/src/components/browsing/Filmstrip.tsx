...
import { FILMSTRIP_GAP, filmstripItemWidth, orderVisibleFilmstripItems, shouldFetchFilmstripPage } from "@/lib/preview/loupe";
import { requestMetadata } from "@/lib/api";
import { getBatchedAssetTags } from "@/lib/assets/assetTagBatch";
import { acceptMetadataProjections } from "@/lib/projection/metadataProjection";
import { filmstripPreviewIntents, PreviewScheduleScope } from "@/lib/preview/previewScheduling";
import { useWorkspaceStore } from "@/store";
import type { AssetSummary } from "@/types";
import { AssetMetadataBadges } from "@/components/common/AssetMetadataBadges";
import { FilmstripPreviewPreloader } from "@/components/loupe/FilmstripPreviewPreloader";
import { Thumbnail } from "./Thumbnail";
import { installFilmstripWheel } from "@/lib/ui/filmstripWheel";
