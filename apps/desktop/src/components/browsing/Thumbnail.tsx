...
import { previewRequestSignal, retainPreviewRequest } from "@/lib/preview/previewRequestLifetime";
import { isPerfActive, perfMark } from "@/lib/diagnostics/perfProbe";
...
import { beginPreviewDebug, type PreviewDebugHandle } from "@/lib/diagnostics/previewDebug";
import { previewContentStyles, validPreviewGeometry, type DisplayedPreviewSize } from "@/lib/preview/previewGeometry";
import { nextProgressiveStage } from "@/lib/preview/progressiveImage";
import { rawPreviewStatus, type RawPreviewStatus } from "@/lib/media/rawPreview";
import { getFolderThumbnail, preloadFolderThumbnail, useFolderThumbnail } from "@/lib/cache/folderThumbnailCache";
import type {
  AssetSummary,
  PreviewPriority,
  PreviewResult,
