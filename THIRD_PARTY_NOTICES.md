...
| SCRFD-10G KPS face detection model | User-downloaded face detection for the optional people feature | Not bundled; pinned by `3rdpart/face-models/managed.json`. Public weights are limited to non-commercial research unless separately licensed by InsightFace |
| AdaFace IR-101 face recognition model | User-downloaded face embeddings for the optional people feature | Not bundled; pinned by `3rdpart/face-models/managed.json`. Weight redistribution and commercial-use terms require release review |
