...
node scripts/perf-e2e.mjs --scenario cold-preview-hif --scenario navigation-cache-hif --scenario filmstrip-scroll-hif --scenario resource-stress-small-grid --runs 1
node scripts/perf-e2e.mjs --scenario resource-stress-hif --runs 1
```
