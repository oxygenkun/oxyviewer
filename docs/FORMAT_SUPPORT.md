...
| HEIF/HEIC/HIF | Implemented | 512/4096 px preview plus cancellable full-resolution RGBA8 tile session; Windows WIC native decoder, dynamic FFmpeg software tile-grid backend, and libheif fallback; hardware adapters remain pending GPU qualification | Planned ExifTool worker | Planned embedded write |
